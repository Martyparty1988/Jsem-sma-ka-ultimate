...
test('Critical Impact Reveal keeps authoritative order inside the v90 lifecycle bundle', () => {
  ...
  assert.match(serviceWorker, /const CACHE_VERSION = 'v90'/);
  assert.match(serviceWorker, /\.\/lifecycle-runtime\.js\?v=90/);
});
